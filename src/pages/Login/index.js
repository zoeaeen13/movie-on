        ...
        <div className={`card ${isRegister && 'card-flip'}`}>
          <section className="login card-front">
            ...
            <div className="login-group">
              <input className="login-group-input" type="text" autoComplete="off"/>
              <label className="login-group-label">帳號 Username</label>
            </div>
            <div className="login-group">
              <input className="login-group-input" type="password" autoComplete="off"/>
          ...
          <section className="register card-back">
            ...
            <div className="register-group">
              <input className="register-group-input" type="email" autoComplete="off"/>
              <label className="register-group-label">註冊信箱 Email</label>
            </div>
            <div className="register-group">
              <input className="register-group-input" type="text" autoComplete="off"/>
              <label className="register-group-label">帳號 Username</label>
            </div>
            <div className="register-group">
              <input className="register-group-input" type="password" autoComplete="off"/>
